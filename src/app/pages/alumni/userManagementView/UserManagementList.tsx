...
const UserManagementList: React.FC = () => {
  ...
  useEffect(() => {
    const filteredSuggestions = users
      .filter(user => user.name.toLowerCase().startsWith(searchText.toLowerCase()))
      .map(user => user.name);
        ...
        <div className='card-toolbar'>
          <div className='d-flex justify-content-end' data-kt-user-table-toolbar='base'>
            <button type='button' className='btn btn-primary' onClick={openModal}>
              ...
              Add UserManagementList Experience
            </button>
          </div>
        </div>
      </div> */}
      ...
      <div className='card-header border-0 pt-6'>
        ...
        <div className='card-toolbar'>
          ...
          <div className='d-flex justify-content-end' data-kt-user-table-toolbar='base'>
            ...
            >
              <i className='ki-duotone ki-exit-up fs-2 btn_yellow'>
                <span className='path1' />
                <span className='path2' />
              </i>
              Export
                      ...
                      <a href='viewuser'>
                        <div className='symbol-label'>
                          ...
                          {user.image &&
                            ...
                            <a className='w-100' href={URL.createObjectURL(user.image)} >
                              {user.imageName}
                            </a >
