  ...
  return (
    <>
      ...
      >
        ...
        <SidebarMenuItem title='Skills' to='/alumni/account/skills' icon='setting-2' />
        <SidebarMenuItem title='Academics' to='/alumni/account/academics' icon='setting-2' />
        <SidebarMenuItem title='Work' to='/alumni/account/work' icon='setting-2' />
      </SidebarMenuItemWithSub>
